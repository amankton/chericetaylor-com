...
import { GraduationCap, Briefcase, Mic, Users, Heart, Award, BookOpen, Home } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-[2fr_3fr] gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <a href="/contact" className="inline-flex items-center gap-3 px-6 py-3 bg-stone-900 text-stone-50 rounded-xl shadow-lg hover:bg-stone-800 transition-colors">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <div className="space-y-12">
          ...
          <div>
            ...
            <p className="text-stone-600 font-light leading-relaxed">
              Cherice is married to Eric, a retired Naval Lieutenant Commander, and together they have four sons. As a military spouse, she understands firsthand the unique challenges military families face—from frequent relocations to maintaining educational continuity for children. This experience has deepened her commitment to supporting military families through her work and advocacy.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-stone-50 rounded-2xl p-8 border border-stone-200">
              ...
              <p className="text-stone-600 font-light leading-relaxed mb-4">
                Regular contributor to <strong className="font-medium text-stone-900">FXBG Neighbors Stafford Living</strong> and <strong className="font-medium text-stone-900">Neighbors of Courthouse</strong> magazines, sharing practical parenting and education advice.
              </p>
            </div>
