                        ...
                        <div className="grid w-full auto-cols-max auto-rows-max grid-cols-1 grid-rows-[max-content] gap-x-12 gap-y-8 sm:grid-cols-2 lg:gap-y-2">
                          ...
                          >
                            ...
                            <div className="flex w-full flex-col justify-center self-center lg:w-auto">
                              ...
                              <p className="text-sm">
                                Insights on building better classrooms
                              </p>
                              <Button
                                title="Listen"
                                variant="link"
                          ...
                          >
                            ...
                            <div className="flex w-full flex-col justify-center self-center lg:w-auto">
                              ...
                              <p className="text-sm">
                                Guidance for young professionals starting out
                              </p>
                              <Button
                                title="Listen"
                                variant="link"
                          ...
                          >
                            ...
                            <div className="flex w-full flex-col justify-center self-center lg:w-auto">
                              ...
                              <p className="text-sm">
                                Navigating transformation in education systems
                              </p>
                              <Button
                                title="Listen"
                                variant="link"
                          ...
                          >
                            ...
                            <div className="flex w-full flex-col justify-center self-center lg:w-auto">
                              ...
                              <p className="text-sm">
                                Creating meaningful moments with those you love
                              </p>
                              <Button
                                title="Listen"
                                variant="link"
